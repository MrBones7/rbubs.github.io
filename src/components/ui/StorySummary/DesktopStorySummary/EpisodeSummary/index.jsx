...
const EpisodeSummary = ({episodeSummary : { seasonName, episodeName, owned, mintedCopies, totalCopies, price }}) => {
  return (
    <div className="w-50">
      <p className="namet m-0">
        {seasonName}, EPISODE: <br />
        {episodeName}
      </p>
